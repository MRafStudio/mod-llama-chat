...
// queue that LlamaDispatch_Update() drains on the world thread, which is the
...
struct LlamaChatRequest
{
    ...
    // Generation.
    std::string       prompt;
    LlamaRequestKind kind = LlamaRequestKind::ChatReply;
