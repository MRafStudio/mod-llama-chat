#ifndef MOD_LLAMA_WOW_GOVERNOR_H
#define MOD_LLAMA_WOW_GOVERNOR_H
...
// Similarity in [0,1]; exposed for the .llamawow status command and testing.
...
// Snapshot for the .llamawow status command.
...
#endif // MOD_LLAMA_WOW_GOVERNOR_H
