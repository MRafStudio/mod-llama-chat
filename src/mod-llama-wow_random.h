#ifndef MOD_LLAMA_WOW_RANDOM_H
#define MOD_LLAMA_WOW_RANDOM_H
...
class LlamaWowBotRandomChatter : public WorldScript
{
public:
    LlamaWowBotRandomChatter();
