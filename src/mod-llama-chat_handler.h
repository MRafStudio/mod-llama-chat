#ifndef MOD_LLAMA_HANDLER_H
#define MOD_LLAMA_HANDLER_H
...
class LlamaChatMaintenance : public PlayerScript
{
public:
    LlamaChatMaintenance() : PlayerScript("LlamaChatMaintenance", { PLAYERHOOK_ON_LOGOUT }) {}
    void OnPlayerLogout(Player* player) override;
};

#endif // MOD_LLAMA_HANDLER_H
