#ifndef MOD_LLAMA_WOW_WORLD_H
#define MOD_LLAMA_WOW_WORLD_H
...
inline bool LlamaWowIsRealPlayer(Player* player)
{
    return player && !LlamaWowIsBotPlayer(player);
}
