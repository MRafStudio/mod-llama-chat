#ifndef MOD_LLAMA_WOW_DISPATCH_H
#define MOD_LLAMA_WOW_DISPATCH_H
...
// queue that LlamaWowDispatch_Update() drains on the world thread, which is the
...
struct LlamaWowChatRequest
{
    ...
    // Generation.
    std::string       prompt;
    LlamaWowRequestKind kind = LlamaWowRequestKind::ChatReply;
...
#endif // MOD_LLAMA_WOW_DISPATCH_H
