#ifndef MOD_LLAMA_WOW_HANDLER_H
#define MOD_LLAMA_WOW_HANDLER_H
...
class LlamaWowChatMaintenance : public PlayerScript
{
public:
    LlamaWowChatMaintenance() : PlayerScript("LlamaWowChatMaintenance", { PLAYERHOOK_ON_LOGOUT }) {}
    void OnPlayerLogout(Player* player) override;
};

#endif // MOD_LLAMA_WOW_HANDLER_H
