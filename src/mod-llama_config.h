#ifndef MOD_LLAMA_CONFIG_H
#define MOD_LLAMA_CONFIG_H
...
// --------------------------------------------
extern std::string g_LlamaUrl;
extern std::string g_LlamaModel;
extern uint32_t    g_LlamaNumPredict;
extern float       g_LlamaTemperature;
extern float       g_LlamaTopP;
extern float       g_LlamaRepeatPenalty;
extern uint32_t    g_LlamaNumCtx;
extern uint32_t    g_LlamaNumThreads;
extern std::string g_LlamaStop;
extern std::string g_LlamaSystemPrompt;
extern std::string g_LlamaSeed;
...
extern int32_t     g_LlamaTopK;              // -1 = unset
extern float       g_LlamaMinP;              // -1 = unset
extern float       g_LlamaPresencePenalty;   // <= -999 = unset
extern float       g_LlamaFrequencyPenalty;  // <= -999 = unset
...
// llama: локализованные промпты личностей: key -> (id локали -> текст)
...
extern LlamaRAGSystem* g_RAGSystem;                     // Global RAG system instance
...
// --------------------------------------------
class LlamaChatConfigWorldScript : public WorldScript
{
public:
    LlamaChatConfigWorldScript();
    void OnStartup() override;
    void OnShutdown() override;
};

#endif // MOD_LLAMA_CONFIG_H
