#include "mod-ollama-chat_openai.h"
...
namespace
{
    ...
    thread_local OllamaHttpClient t_openAiClient;
...
namespace OllamaOpenAi
{
                                ...
                                uint32_t reasoningReserve)
    {
        ...
        OllamaHttpResult http = t_openAiClient.PostExWithToken(cfg.url, request.dump(), cfg.openAiKey);
        ...
        if (g_DebugEnabled)
            LOG_INFO("module.ollamachat", "[Ollama Chat] OpenAI-compatible reply ok in {}ms (finish_reason={})",
