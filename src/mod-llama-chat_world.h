#ifndef MOD_LLAMA_WORLD_H
#define MOD_LLAMA_WORLD_H
...
inline bool LlamaIsRealPlayer(Player* player)
{
    return player && !LlamaIsBotPlayer(player);
}
