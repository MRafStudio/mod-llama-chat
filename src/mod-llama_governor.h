#ifndef MOD_LLAMA_GOVERNOR_H
#define MOD_LLAMA_GOVERNOR_H
...
// Similarity in [0,1]; exposed for the .llama status command and testing.
...
// Snapshot for the .llama status command.
