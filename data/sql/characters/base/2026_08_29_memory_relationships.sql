...
--
-- Conversation history (mod_llama_chat_history) is a sliding window: once a
...
CREATE TABLE IF NOT EXISTS mod_llama_chat_memories (
...
CREATE TABLE IF NOT EXISTS mod_llama_chat_relationships (
    bot_guid BIGINT UNSIGNED NOT NULL,
