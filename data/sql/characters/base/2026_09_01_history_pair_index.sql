...
--
-- mod_llama_chat_history shipped with only its primary key and a UNIQUE key
...
SET @have_index := (
    ...
    WHERE TABLE_SCHEMA = DATABASE()
      AND TABLE_NAME   = 'mod_llama_chat_history'
      AND INDEX_NAME   = 'idx_pair_recent'
);

SET @ddl := IF(@have_index = 0,
    'ALTER TABLE mod_llama_chat_history ADD INDEX idx_pair_recent (bot_guid, player_guid, id)',
    'DO 0');
