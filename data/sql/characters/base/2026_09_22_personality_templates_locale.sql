...
-- Схема: mod_llama_chat_personality_templates_locale (`key`, `Locale`, `prompt`)

DROP TABLE IF EXISTS `mod_llama_chat_personality_templates_locale`;
CREATE TABLE IF NOT EXISTS `mod_llama_chat_personality_templates_locale` (
...
INSERT INTO `mod_llama_chat_personality_templates_locale` (`key`, `Locale`, `prompt`) VALUES
